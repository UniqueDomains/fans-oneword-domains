# Available .FANS One-Word Domains (9,644)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C643%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-9%2C644%20domains-6f42c1">
...
> **Important:** this repository is a **public 9,643-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **9,644 domains** on the canonical page below.

**Public extract:** 9,643 rows · **Live catalog:** 9,644 domains
...
- `fans.csv` — public CSV extract (9,643 rows)
- `fans.json` — public JSON extract (9,643 rows)
...
| --------------- | --------- | ---------- | ------------- | -------------- | ------ | ------ | ------------------------------------------------------- |
| remedial.fans   | available | $13.98     | —             | 86             | 24     | 8      | namecheap                                               |
| home.fans       | resell    | —          | —             | 90             | 61     | 4      | Alibaba Cloud Computing Ltd. d/b/a HiChina (www.net.cn) |
| nationwide.fans | premium   | $65        | $65           | 76             | 66     | 10     | namecheap                                               |
...
| realestate.fans | resell    | —          | —             | —              | 40     | 11     | Spaceship, Inc.                                         |
| data.fans       | premium   | $650       | $650          | 70             | 56     | 4      | namecheap                                               |
| covert.fans     | available | $13.98     | —             | 60             | 18     | 6      | namecheap                                               |
| kindof.fans     | resell    | —          | —             | 62             | 5      | 7      | Namecheap                                               |
...
| ----------------------- | ------------------------------------------------ |
| 9,643-row public sample | 9,644 live domains                               |
...
> Unique Domains. *Available .FANS One-Word Domains*. Version 2026-04-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
